 ...
 * @author Eduardo M
 */
public abstract class CRUD_SERVIDOR<T> {

    private EntityManager em;
    private Class<T> classe;

    public CRUD_SERVIDOR(Class<T> classe) {
        this.classe = classe;
        if (em == null) {
            EntityManagerFactory emf = Persistence.createEntityManagerFactory("SupermercadoXMLPU_Servidor");
